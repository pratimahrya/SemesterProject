...
# All variables used==
        ...
        txt_search = Entry(SearchFrame, textvariable=self.var_searchtxt, font=("goudy old style", 15),
                           bg="#FFFFE0").place(x=200, y=10)
        btn_search = Button(SearchFrame, text="Search",command=self.search,font=("goudy old style", 15), bg="#4caf50", fg="#154c79").place(
            x=410, y=10, width=150, height=30)
        ...
        # ===content===
        # --firstrow--
        lbl_empid = Label(self.root, text="Emp ID", font=("goudy old style", 15)).place(x=50, y=150)
        lbl_gender = Label(self.root, text="Gender", font=("goudy old style", 15)).place(x=350, y=150)
        lbl_contact = Label(self.root, text="Contact", font=("goudy old style", 15)).place(x=750, y=150)

        txt_empid = Entry(self.root, textvariable=self.var_emp_id, font=("goudy old style", 15),
                          bg="lightyellow").place(x=150, y=150, width=180)

        # txt_gender = Entry(self.root, textvariable=self.var_gender, font=("goudy old style", 15)).place(x=500,y=150, width=180)
        cmb_gender = ttk.Combobox(self.root, textvariable=self.var_gender, values=("Select", "Female", "Male", "Other"),
        ...
        lbl_dob = Label(self.root, text="D.O.B", font=("goudy old style", 15)).place(x=350, y=190)
        ...
        # --row3--
        lbl_email = Label(self.root, text="Email", font=("goudy old style", 15)).place(x=50, y=230)
        lbl_pass = Label(self.root, text="Password", font=("goudy old style", 15)).place(x=350, y=230)
        lbl_utype = Label(self.root, text="User Type", font=("goudy old style", 15)).place(x=750, y=230)
        ...
        # txt_utype = Entry(self.root, textvariable=self.var_utype, font=("goudy old style", 15),
        # bg="lightyellow").place(x=850, y=230, width=180)
        ...
        # --row4--
        lbl_address = Label(self.root, text="Address", font=("goudy old style", 15)).place(x=50, y=270)
        lbl_salary = Label(self.root, text="Salary", font=("goudy old style", 15)).place(x=500, y=270)
        ...
        btn_add = Button(self.root, text="Save", command=self.add, font=("goudy old style", 15), bg='#2196f3',
                         fg="#154c79").place(x=500, y=305, width=110, height=28)
        btn_update = Button(self.root, text="Update",command=self.update ,font=("goudy old style", 15), bg='#4caf50',
                            fg="#154c79").place(x=620, y=305, width=110, height=28)
        btn_delete = Button(self.root, text="Delete",command=self.delete ,font=("goudy old style", 15), bg='#f44336', fg="#154c79").place(
            x=740, y=305, width=110, height=28)
        btn_clear = Button(self.root, text="Clear",command=self.clear ,font=("goudy old style", 15), bg='#607d8b', fg="#154c79").place(
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                row = cur.fetchone()
                if row != None:
                    messagebox.showerror("ERROR", "ID already assigned!", parent=self.root)
                else:
                    cur.execute(
